"""
Batch 3 交叉验证执行脚本 — 对 3 个维度执行 cross_validate。
用法: cd clinical_reasoning_agent && python scripts/run_batch3_crossval.py
"""
...
BASE = Path("docs/conversations/engineering_blueprint/batch3")
OUT  = BASE
